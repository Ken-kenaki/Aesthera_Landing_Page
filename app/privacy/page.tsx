            ...
            <section className="pt-48 pb-32 px-8 max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="prose dark:prose-invert max-w-none space-y-12 prose-headings:text-on-background prose-strong:text-on-background prose-a:text-primary">
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">1. Information We Collect</h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">2. How We Use Information</h2>
                            <p className="text-on-surface-variant leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">3. Data Security</h2>
                            <p className="text-on-surface-variant leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">4. Third-Party Services</h2>
                            <p className="text-on-surface-variant leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">5. Changes to This Policy</h2>
                            <p className="text-on-surface-variant leading-relaxed">
