        ...
        <div className="bg-background text-on-background font-body selection:bg-primary selection:text-on-primary min-h-screen">
            <section className="pt-48 pb-32 px-8 max-w-4xl mx-auto">
                ...
                >
                    ...
                    <h1 className="font-headline text-5xl md:text-7xl font-black tracking-tighter text-on-background uppercase mb-4">
                        Terms of Service
                    </h1>
                    ...
                    <div className="prose dark:prose-invert max-w-none space-y-12 prose-headings:text-on-background prose-strong:text-on-background prose-a:text-primary">
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">1. Acceptance of Terms</h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">2. Description of Service</h2>
                            <p className="text-on-surface-variant leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">3. User Obligations</h2>
                            <p className="text-on-surface-variant leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">4. Intellectual Property</h2>
                            <p className="text-on-surface-variant leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">5. Limitation of Liability</h2>
                            <p className="text-on-surface-variant leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight mb-6">6. Governing Law</h2>
                            <p className="text-on-surface-variant leading-relaxed">
