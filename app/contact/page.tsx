  ...
  return (
    <div className="bg-background text-on-background font-body selection:bg-primary selection:text-on-primary">
      ...
      <section className="max-w-screen-2xl mx-auto px-8 mb-24 pt-32">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-end">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black font-headline tracking-tighter text-on-background leading-[0.9]">
              Start a <br />Project.
            </h1>
          </motion.div>
          <motion.div
      ...
      <section className="max-w-screen-2xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-12 gap-4">
        {/* Contact Form Module */}
        <div className="lg:col-span-7 bg-surface-container-low p-8 md:p-12 relative overflow-hidden group border border-outline/5 rounded-2xl">
          <div className="relative z-10">
            <h2 className="text-3xl font-bold font-headline text-on-surface mb-12">Transmission Brief</h2>
            <form className="space-y-12">
              <div className="relative">
                <input className="peer w-full bg-transparent border-t-0 border-l-0 border-r-0 border-b border-outline-variant focus:border-primary focus:ring-0 transition-all duration-500 py-4 px-0 text-on-surface placeholder-transparent focus:outline-none" id="full_name" placeholder=" " type="text" />
              ...
              <div className="relative">
                <input className="peer w-full bg-transparent border-t-0 border-l-0 border-r-0 border-b border-outline-variant focus:border-primary focus:ring-0 transition-all duration-500 py-4 px-0 text-on-surface placeholder-transparent focus:outline-none" id="email" placeholder=" " type="email" />
                <label className="absolute left-0 -top-1 text-xs text-secondary uppercase tracking-widest transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-4 peer-placeholder-shown:text-on-surface-variant peer-focus:-top-1 peer-focus:text-xs peer-focus:text-primary pointer-events-none" htmlFor="email">Email address</label>
              </div>
              <div className="relative">
                <textarea className="peer w-full bg-transparent border-t-0 border-l-0 border-r-0 border-b border-outline-variant focus:border-primary focus:ring-0 transition-all duration-500 py-4 px-0 text-on-surface placeholder-transparent resize-none focus:outline-none" id="message" placeholder=" " rows={4}></textarea>
                <label className="absolute left-0 -top-1 text-xs text-secondary uppercase tracking-widest transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-4 peer-placeholder-shown:text-on-surface-variant peer-focus:-top-1 peer-focus:text-xs peer-focus:text-primary pointer-events-none" htmlFor="message">Message field</label>
              </div>
              <button className="group/btn flex items-center justify-between w-full md:w-auto md:min-w-[240px] kinetic-gradient text-on-primary px-8 py-5 font-bold uppercase tracking-widest text-xs hover:scale-[1.02] neon-glow-primary transition-all duration-300" type="submit">
                Send Transmission
        ...
        <div className="lg:col-span-5 space-y-4">
          {/* Inquiry Module */}
          <div className="bg-surface-container-highest p-8 md:p-10 flex flex-col justify-between h-auto border border-outline/5 rounded-2xl">
            <div>
              <span className="text-secondary text-[10px] uppercase tracking-[0.3em] font-bold mb-2 block">Direct Channel</span>
              <h3 className="text-xl font-bold font-headline text-on-surface mb-6 uppercase tracking-tight">Inquiries</h3>
            </div>
            <a className="text-3xl md:text-4xl font-light font-headline text-on-surface hover:text-primary transition-colors duration-300 break-all" href="mailto:hello@aesthera.tech">
              hello@aesthera.tech
            </a>
          </div>
          {/* Locations Bento Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-surface-container-low p-8 border border-outline/10 rounded-2xl">
              <MapPin className="text-secondary mb-6 w-6 h-6" />
              <h4 className="font-headline font-bold text-on-surface mb-2">Kathmandu</h4>
            ...
            <div className="bg-surface-container-low p-8 border border-outline/10 rounded-2xl">
              ...
              <h4 className="font-headline font-bold text-on-surface mb-2">United Kingdom</h4>
              <p className="text-on-surface-variant text-sm leading-relaxed">
          ...
          <div className="h-48 bg-surface-container-highest overflow-hidden relative grayscale opacity-50 hover:opacity-100 transition-opacity duration-700 rounded-2xl border border-outline/10">
            ...
            <div className="absolute bottom-4 left-4 z-20">
              <div className="flex items-center space-x-2 bg-surface-container/90 backdrop-blur-md px-3 py-1.5 rounded-full border border-outline/20">
                <span className="w-2 h-2 bg-primary rounded-full animate-pulse"></span>
                <span className="text-[10px] font-bold uppercase tracking-widest text-on-surface">Live Node</span>
              </div>
            </div>
          </div>
        </div>
